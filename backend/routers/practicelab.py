...
from routers.practicelab_pkg import config, batches, grading, analytics, self_practice, ed_grading, practice_sessions, em_grading
...
router.include_router(em_grading.router)
