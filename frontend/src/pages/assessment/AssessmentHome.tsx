...
import { ArrowLeft, BookOpen, PlusSquare, Clock } from 'lucide-react'
import { useNavigate } from 'react-router-dom'
import { QuestionBankView } from './QuestionBankView'
import { GenerateView } from './GenerateView'
import { AssessmentHistoryView } from './AssessmentHistoryView'

type Tab = 'bank' | 'generate' | 'history'
...
export function AssessmentHome() {
  ...
  const tabs: { id: Tab; label: string; icon: React.ReactNode }[] = [
    { id: 'bank', label: 'Question Bank', icon: <BookOpen size={15} /> },
    ...
    <div style={styles.container}>
      ...
      <div style={styles.topBar}>
        <div style={styles.topBarLeft}>
          ...
          <div style={styles.pageTitle}>Assessment Management</div>
        </div>
        <span style={styles.portalBadge}>Assessment Engine</span>
      </div>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  blob1: {
    ...
    opacity: 0.2, filter: 'blur(60px)', pointerEvents: 'none',
  },
  blob2: {
    position: 'absolute', bottom: 40, right: -60, width: 280, height: 280,
    borderRadius: '50%',
  ...
  backBtn: {
    ...
    fontSize: 13, color: '#4b5563', fontWeight: 600,
  },
