...
import { Loader, TrendingUp, BarChart2, User, Award, Clock, AlertCircle, CheckCircle, XCircle, Layers, Tag } from 'lucide-react'
...
type AnalyticsTab = 'overview' | 'drill' | 'coder' | 'specialty' | 'topic'
