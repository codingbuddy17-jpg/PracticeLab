...
const styles: Record<string, React.CSSProperties> = {
  ...
  title: { fontWeight: 800, fontSize: 18, color: '#4f46e5', letterSpacing: -0.5 },
  ...
  chipActive: { padding: '5px 14px', borderRadius: 20, border: '1.5px solid #4f46e5', background: '#ede9fe', color: '#4f46e5', cursor: 'pointer', fontSize: 13, fontWeight: 700 },
  actionRow: { display: 'flex', flexWrap: 'wrap', gap: 10 },
  primaryBtn: { display: 'inline-flex', alignItems: 'center', gap: 6, padding: '9px 18px', background: '#4f46e5', color: '#fff', border: 'none', borderRadius: 8, cursor: 'pointer', fontSize: 13, fontWeight: 700 },
  ...
  infoBox: { background: '#eef2ff', border: '1px solid #c7d2fe', borderRadius: 8, padding: '12px 16px', fontSize: 13, color: '#3730a3' },
